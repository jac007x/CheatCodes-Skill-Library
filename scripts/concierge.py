    ...
    "hr-analytics": [
        {
            ...
            "name": "MBR Engine",
            "emoji": "📈",
            "tagline": "Automate your Monthly Business Review from HR data",
            "description": (
                "Extract org health metrics from HR rosters, detect patterns, and generate "
            ...
            "versions": {
                "v2": {
                    ...
                    "placeholders": {
                        ...
                        "MONTH": "Reporting month in YYYY-MM format (e.g. '2026-03')",
                        "KEY CONCERNS": "Any specific focus areas? (e.g. 'attrition spike in APAC') — or 'none'",
                    },
                    "prompt": (
